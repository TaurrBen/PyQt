...
"""
# File       : kuaishou_store_impl.py
# Time       ：2025.2.26 23:56
# Author     ：Benboy
...
class KuaishouCsvStoreImplement(AbstractStore):
    ...
    csv_store_path: str = "out/spider/kuaishou"
...
class KuaishouJsonStoreImplement(AbstractStore):
    json_store_path: str = "out/spider/kuaishou/json"
    words_store_path: str = "out/spider/kuaishou/words"
    lock = asyncio.Lock()
