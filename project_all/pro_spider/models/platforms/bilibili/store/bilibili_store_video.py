...
"""
# File       : bilibili_store_video.py
# Time       ：2025.2.22 12:14
# Author     ：Benboy
# Email      : hgq1633923487@gmail.com
# version    ：python 3.9
# Description：bilibili图片保存
"""
...
class BilibiliVideo(spider.AbstractStoreImage):
    ...
    async def save_video(self, aid: int, video_content: str, extension_file_name="mp4"):
        ...
        async with aiofiles.open(save_file_name, 'wb') as f:
            ...
            config.logger.info(f"[BilibiliVideoImplement.save_video] save save_video {save_file_name} success ...")
