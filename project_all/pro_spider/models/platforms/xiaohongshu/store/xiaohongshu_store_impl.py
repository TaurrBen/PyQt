...
"""
# File       : xiaohongshu_store_impl.py
# Time       ：2025.2.27 0:39
# Author     ：Benboy
# Email      : hgq1633923487@gmail.com
# version    ：python 3.9
# Description：小红书存储实现类
"""
...
class XhsCsvStoreImplement(AbstractStore):
    csv_store_path: str = "out/spider/xiaohongshu"
...
class XhsDbStoreImplement(AbstractStore):
    async def store_content(self, content_item: Dict):
        ...
        """
        from .xiaohongshu_store_sql import (add_new_content,
    ...
    async def store_comment(self, comment_item: Dict):
        ...
        """
        from .xiaohongshu_store_sql import (add_new_comment,
    ...
    async def store_creator(self, creator: Dict):
        ...
        """
        from .xiaohongshu_store_sql import (add_new_creator, query_creator_by_user_id,
...
class XhsJsonStoreImplement(AbstractStore):
    json_store_path: str = "out/spider/xiaohongshu/json"
    words_store_path: str = "out/spider/xiaohongshu/words"
    lock = asyncio.Lock()
