...
"""
# File       : xiaohongshu_store_image.py
# Time       ：2025.2.27 0:39
# Author     ：Benboy
...
class XiaoHongShuImage(AbstractStoreImage):
    image_store_path: str = "out/spider/xiaohongshu/images"
    ...
    async def save_image(self, notice_id: str, pic_content: str, extension_file_name="jpg"):
        ...
        async with aiofiles.open(save_file_name, 'wb') as f:
            ...
            config.logger.info(f"[XiaoHongShuImageStoreImplement.save_image] save image {save_file_name} success ...")
