...
async def update_weibo_note(note_item: Dict):
    ...
    save_content_item = {
        ...
        "note_id": note_id,
        "content": clean_text,
        "create_time": time_utils.rfc2822_to_timestamp(mblog.get("created_at")),
        "create_date_time": str(time_utils.rfc2822_to_china_datetime(mblog.get("created_at"))),
...
async def update_weibo_note_comment(note_id: str, comment_item: Dict):
    ...
    save_comment_item = {
        ...
        "create_time": time_utils.rfc2822_to_timestamp(comment_item.get("created_at")),
        "create_date_time": str(time_utils.rfc2822_to_china_datetime(comment_item.get("created_at"))),
        "note_id": note_id,
        "content": clean_text,
...
async def save_creator(user_id: str, user_info: Dict):
    ...
    config.logger.info(f"[store.weibo.save_creator] creator:{local_db_item}")
