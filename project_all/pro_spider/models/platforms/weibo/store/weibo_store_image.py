...
class WeiboStoreImage(AbstractStoreImage):
    image_store_path: str = "out/spider/weibo/images"
    ...
    async def save_image(self, picid: str, pic_content: str, extension_file_name="jpg"):
        ...
        async with aiofiles.open(save_file_name, 'wb') as f:
            ...
            config.logger.info(f"[WeiboImageStoreImplement.save_image] save image {save_file_name} success ...")