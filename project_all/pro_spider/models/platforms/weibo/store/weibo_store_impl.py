...
class WeiboCsvStoreImplement(AbstractStore):
    csv_store_path: str = "out/spider/weibo"
    ...
    def make_save_file_name(self, store_type: str) -> str:
        ...
        return f"{self.csv_store_path}/{crawler_type_var.get()}_{store_type}_{time_utils.get_current_date()}.csv"
...
class WeiboJsonStoreImplement(AbstractStore):
    json_store_path: str = "out/spider/weibo/json"
    words_store_path: str = "out/spider/weibo/words"
    lock = asyncio.Lock()
