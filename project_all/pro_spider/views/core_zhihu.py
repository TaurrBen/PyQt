...
from .ui.platforms.zhihu.ui_zhihu import Ui_zhihu
import config
from utils.log import *
from ..controllers.platforms import CrawlerFactory, ZhihuCrawler
...
class View_zhihu():
    ...
    def __init__(self, parent):
        ...
        super(View_zhihu, self).__init__()
        self.build_ui(self.parent)
        self.ui.show()

    def build_ui(self,parent):
        self.ui = Ui_zhihu(parent)
        self.setup_bindings()
