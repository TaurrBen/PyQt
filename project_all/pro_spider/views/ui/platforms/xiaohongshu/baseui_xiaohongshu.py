...
# Form implementation generated from reading ui file 'baseui_xiaohongshu.ui'
#
...
class Ui_baseui_xiaohongshu(object):
    def setupUi(self, baseui_xiaohongshu):
        baseui_xiaohongshu.setObjectName("baseui_xiaohongshu")
        baseui_xiaohongshu.resize(1368, 811)
        self.widget = QtWidgets.QWidget(baseui_xiaohongshu)
        ...
        self.retranslateUi(baseui_xiaohongshu)
        QtCore.QMetaObject.connectSlotsByName(baseui_xiaohongshu)

    def retranslateUi(self, baseui_xiaohongshu):
        _translate = QtCore.QCoreApplication.translate
        baseui_xiaohongshu.setWindowTitle(_translate("baseui_xiaohongshu", "baseui_xiaohongshu"))
        self.label_login_type.setText(_translate("baseui_xiaohongshu", "login_type:"))
        self.comboBox_login_type.setItemText(0, _translate("baseui_xiaohongshu", "cookies"))
        self.comboBox_login_type.setItemText(1, _translate("baseui_xiaohongshu", "qrcode/暂不支持"))
        self.comboBox_login_type.setItemText(2, _translate("baseui_xiaohongshu", "phone/暂不支持"))
        self.checkBox_is_save_login_state.setText(_translate("baseui_xiaohongshu", "is_save_login_state"))
        self.checkBox_is_playwright.setText(_translate("baseui_xiaohongshu", "playwright"))
        self.checkBox_headless.setText(_translate("baseui_xiaohongshu", "headless"))
        self.label_proxy_type.setText(_translate("baseui_xiaohongshu", "proxy:"))
        self.comboBox_proxy_type.setItemText(0, _translate("baseui_xiaohongshu", "none"))
        self.comboBox_proxy_type.setItemText(1, _translate("baseui_xiaohongshu", "kuaidaili"))
        self.label_concurrency_num.setText(_translate("baseui_xiaohongshu", "concurrency_num:"))
        self.lineEdit_concurrency_num.setText(_translate("baseui_xiaohongshu", "3"))
        self.label.setText(_translate("baseui_xiaohongshu", "headers:"))
        self.label_cookies2.setText(_translate("baseui_xiaohongshu", "cookies_in:"))
        self.label_cookies.setText(_translate("baseui_xiaohongshu", "cookies_out:"))
        self.comboBox_type.setItemText(0, _translate("baseui_xiaohongshu", "keywords"))
        self.comboBox_type.setItemText(1, _translate("baseui_xiaohongshu", "bvids"))
        self.comboBox_type.setItemText(2, _translate("baseui_xiaohongshu", "upuser"))
        self.label_keywords.setText(_translate("baseui_xiaohongshu", "keywords:"))
        self.lineEdit_keywords.setText(_translate("baseui_xiaohongshu", "神经网络,深度学习"))
        self.pushButton_keywords.setText(_translate("baseui_xiaohongshu", "open"))
        self.checkBox_start_page.setText(_translate("baseui_xiaohongshu", "start_page:"))
        self.lineEdit_start_page.setText(_translate("baseui_xiaohongshu", "1"))
        self.checkBox_search_type.setText(_translate("baseui_xiaohongshu", "search_type:"))
        self.comboBox_search_type.setItemText(0, _translate("baseui_xiaohongshu", "video"))
        self.comboBox_search_type.setItemText(1, _translate("baseui_xiaohongshu", "media_bangumi"))
        self.comboBox_search_type.setItemText(2, _translate("baseui_xiaohongshu", "media_ft"))
        self.comboBox_search_type.setItemText(3, _translate("baseui_xiaohongshu", "live"))
        self.comboBox_search_type.setItemText(4, _translate("baseui_xiaohongshu", "article"))
        self.comboBox_search_type.setItemText(5, _translate("baseui_xiaohongshu", "bili_user"))
        self.checkBox_order_type.setText(_translate("baseui_xiaohongshu", "order_type:"))
        self.comboBox_order_type.setItemText(0, _translate("baseui_xiaohongshu", "综合排序"))
        self.comboBox_order_type.setItemText(1, _translate("baseui_xiaohongshu", "最多播放"))
        self.comboBox_order_type.setItemText(2, _translate("baseui_xiaohongshu", "最新发布"))
        self.comboBox_order_type.setItemText(3, _translate("baseui_xiaohongshu", "最多弹幕"))
        self.comboBox_order_type.setItemText(4, _translate("baseui_xiaohongshu", "最多收藏"))
        self.checkBox_pubtime.setText(_translate("baseui_xiaohongshu", "pubtime:from"))
        self.label_pubtime.setText(_translate("baseui_xiaohongshu", "to"))
        self.checkBox_duration.setText(_translate("baseui_xiaohongshu", "duration:"))
        self.comboBox_duration.setItemText(0, _translate("baseui_xiaohongshu", "all"))
        self.comboBox_duration.setItemText(1, _translate("baseui_xiaohongshu", "<10m"))
        self.comboBox_duration.setItemText(2, _translate("baseui_xiaohongshu", "≥10m&<30m"))
        self.comboBox_duration.setItemText(3, _translate("baseui_xiaohongshu", "≥30m&<60m"))
        self.comboBox_duration.setItemText(4, _translate("baseui_xiaohongshu", "≥60m"))
        self.checkBox_tids.setText(_translate("baseui_xiaohongshu", "tids"))
        self.comboBox_tids.setItemText(0, _translate("baseui_xiaohongshu", "综合分区"))
        self.comboBox_tids.setItemText(1, _translate("baseui_xiaohongshu", "动画"))
        self.comboBox_tids.setItemText(2, _translate("baseui_xiaohongshu", "番剧"))
        self.comboBox_tids.setItemText(3, _translate("baseui_xiaohongshu", "国创"))
        self.comboBox_tids.setItemText(4, _translate("baseui_xiaohongshu", "音乐"))
        self.comboBox_tids.setItemText(5, _translate("baseui_xiaohongshu", "舞蹈"))
        self.comboBox_tids.setItemText(6, _translate("baseui_xiaohongshu", "游戏"))
        self.comboBox_tids.setItemText(7, _translate("baseui_xiaohongshu", "知识"))
        self.comboBox_tids.setItemText(8, _translate("baseui_xiaohongshu", "科技"))
        self.comboBox_tids.setItemText(9, _translate("baseui_xiaohongshu", "运动"))
        self.comboBox_tids.setItemText(10, _translate("baseui_xiaohongshu", "汽车"))
        self.comboBox_tids.setItemText(11, _translate("baseui_xiaohongshu", "生活"))
        self.comboBox_tids.setItemText(12, _translate("baseui_xiaohongshu", "美食"))
        self.comboBox_tids.setItemText(13, _translate("baseui_xiaohongshu", "动物圈"))
        self.comboBox_tids.setItemText(14, _translate("baseui_xiaohongshu", "鬼畜"))
        self.comboBox_tids.setItemText(15, _translate("baseui_xiaohongshu", "时尚"))
        self.comboBox_tids.setItemText(16, _translate("baseui_xiaohongshu", "咨询"))
        self.comboBox_tids.setItemText(17, _translate("baseui_xiaohongshu", "娱乐"))
        self.comboBox_tids.setItemText(18, _translate("baseui_xiaohongshu", "影视"))
        self.comboBox_tids.setItemText(19, _translate("baseui_xiaohongshu", "纪录片"))
        self.comboBox_tids.setItemText(20, _translate("baseui_xiaohongshu", "电影"))
        self.comboBox_tids.setItemText(21, _translate("baseui_xiaohongshu", "电视剧"))
        self.label_bvids.setText(_translate("baseui_xiaohongshu", "bvids:"))
        self.lineEdit_bvids.setText(_translate("baseui_xiaohongshu", "BV1iezPYCEY3,BV16JXXYsEXv"))
        self.pushButton_bvids.setText(_translate("baseui_xiaohongshu", "open"))
        self.radioButton_other_page.setText(_translate("baseui_xiaohongshu", "other_page"))
        self.label_upusers.setText(_translate("baseui_xiaohongshu", "upuser:"))
        self.lineEdit_upusers.setText(_translate("baseui_xiaohongshu", "339166786"))
        self.pushButton_upusers.setText(_translate("baseui_xiaohongshu", "open"))
        self.comboBox_upusers_type.setItemText(0, _translate("baseui_xiaohongshu", "home"))
        self.comboBox_upusers_type.setItemText(1, _translate("baseui_xiaohongshu", "dynamic"))
        self.comboBox_upusers_type.setItemText(2, _translate("baseui_xiaohongshu", "upload"))
        self.comboBox_upusers_type.setItemText(3, _translate("baseui_xiaohongshu", "lists"))
        self.comboBox_upusers_type.setItemText(4, _translate("baseui_xiaohongshu", "favlist"))
        self.checkBox_download_video.setText(_translate("baseui_xiaohongshu", "download_video"))
        self.checkBox_download_comment.setText(_translate("baseui_xiaohongshu", "download_comment"))
        self.checkBox_download_sub_comment.setText(_translate("baseui_xiaohongshu", "sub_comment"))
        self.label_video_count.setText(_translate("baseui_xiaohongshu", "video_count:"))
        self.lineEdit_video_count.setText(_translate("baseui_xiaohongshu", "20"))
        self.label_comment_count.setText(_translate("baseui_xiaohongshu", "comment_count:"))
        self.lineEdit_conment_count.setText(_translate("baseui_xiaohongshu", "20"))
        self.pushButton_load_params.setText(_translate("baseui_xiaohongshu", "load_params"))
        self.pushButton_start_search.setText(_translate("baseui_xiaohongshu", "start_search"))
        self.pushButton_stop_search.setText(_translate("baseui_xiaohongshu", "stop_search"))
        self.label_video_items.setText(_translate("baseui_xiaohongshu", "video_items"))
        self.checkBox_video_items_is_save.setText(_translate("baseui_xiaohongshu", "is_save"))
        self.pushButton_video_items_export.setText(_translate("baseui_xiaohongshu", "export"))
        item = self.tableWidget_video_items.horizontalHeaderItem(0)
        item.setText(_translate("baseui_xiaohongshu", "keyword"))
        item = self.tableWidget_video_items.horizontalHeaderItem(1)
        item.setText(_translate("baseui_xiaohongshu", "video_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(2)
        item.setText(_translate("baseui_xiaohongshu", "video_type"))
        item = self.tableWidget_video_items.horizontalHeaderItem(3)
        item.setText(_translate("baseui_xiaohongshu", "title"))
        item = self.tableWidget_video_items.horizontalHeaderItem(4)
        item.setText(_translate("baseui_xiaohongshu", "desc"))
        item = self.tableWidget_video_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_xiaohongshu", "create_time"))
        item = self.tableWidget_video_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_xiaohongshu", "user_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_xiaohongshu", "nickname"))
        item = self.tableWidget_video_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_xiaohongshu", "avatar"))
        item = self.tableWidget_video_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_xiaohongshu", "liked_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(10)
        item.setText(_translate("baseui_xiaohongshu", "video_play_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(11)
        item.setText(_translate("baseui_xiaohongshu", "video_danmaku"))
        item = self.tableWidget_video_items.horizontalHeaderItem(12)
        item.setText(_translate("baseui_xiaohongshu", "video_comment"))
        item = self.tableWidget_video_items.horizontalHeaderItem(13)
        item.setText(_translate("baseui_xiaohongshu", "last_modify_ts"))
        item = self.tableWidget_video_items.horizontalHeaderItem(14)
        item.setText(_translate("baseui_xiaohongshu", "video_url"))
        item = self.tableWidget_video_items.horizontalHeaderItem(15)
        item.setText(_translate("baseui_xiaohongshu", "video_cover_url"))
        self.label_video_upuser_items.setText(_translate("baseui_xiaohongshu", "video_upuser_items"))
        self.checkBox_video_upuser_items_is_save.setText(_translate("baseui_xiaohongshu", "is_save"))
        self.pushButton_video_upuser_items_export.setText(_translate("baseui_xiaohongshu", "export"))
        ...
        item.setText(_translate("baseui_xiaohongshu", "total_fans"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_xiaohongshu", "total_liked"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_xiaohongshu", "user_rank"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_xiaohongshu", "is_official"))
        self.label_logs.setText(_translate("baseui_xiaohongshu", "logs"))
        self.checkBox_debug.setText(_translate("baseui_xiaohongshu", "debug"))
        self.pushButton_clear.setText(_translate("baseui_xiaohongshu", "clear"))
