...
class Ui_baseui_douyin(object):
    def setupUi(self, baseui_douyin):
        ...
        self.tableWidget_video_items.setColumnCount(20)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_video_items.setHorizontalHeaderItem(17, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_video_items.setHorizontalHeaderItem(18, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_video_items.setHorizontalHeaderItem(19, item)
        ...
        self.tableWidget_upuser_items.setColumnCount(10)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_upuser_items.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_upuser_items.setHorizontalHeaderItem(9, item)
    ...
    def retranslateUi(self, baseui_douyin):
        ...
        self.label_login_type.setText(_translate("baseui_douyin", "login_type:"))
        self.comboBox_login_type.setItemText(0, _translate("baseui_douyin", "cookies"))
        self.comboBox_login_type.setItemText(1, _translate("baseui_douyin", "qrcode/暂不支持"))
        self.comboBox_login_type.setItemText(2, _translate("baseui_douyin", "phone/暂不支持"))
        self.checkBox_is_save_login_state.setText(_translate("baseui_douyin", "is_save_login_state"))
        ...
        self.label.setText(_translate("baseui_douyin", "headers:"))
        self.label_cookies2.setText(_translate("baseui_douyin", "cookies_in:"))
        self.label_cookies.setText(_translate("baseui_douyin", "cookies_out:"))
        self.comboBox_type.setItemText(0, _translate("baseui_douyin", "keywords"))
        self.comboBox_type.setItemText(1, _translate("baseui_douyin", "bvids"))
        self.comboBox_type.setItemText(2, _translate("baseui_douyin", "upuser"))
        self.label_keywords.setText(_translate("baseui_douyin", "keywords:"))
        self.lineEdit_keywords.setText(_translate("baseui_douyin", "神经网络,深度学习"))
        self.pushButton_keywords.setText(_translate("baseui_douyin", "open"))
        ...
        self.label_bvids.setText(_translate("baseui_douyin", "bvids:"))
        self.lineEdit_bvids.setText(_translate("baseui_douyin", "7476832911644216586,7444173197009866011"))
        self.pushButton_bvids.setText(_translate("baseui_douyin", "open"))
        self.radioButton_other_page.setText(_translate("baseui_douyin", "other_page"))
        self.label_upusers.setText(_translate("baseui_douyin", "upuser:"))
        self.lineEdit_upusers.setText(_translate("baseui_douyin", "MS4wLjABAAAAvOWP0O8CPwmnEUw7EuYPiT51DmXsM_mzbJFMa7ariTs"))
        self.pushButton_upusers.setText(_translate("baseui_douyin", "open"))
        self.comboBox_upusers_type.setItemText(0, _translate("baseui_douyin", "home"))
        self.comboBox_upusers_type.setItemText(1, _translate("baseui_douyin", "dynamic"))
        self.comboBox_upusers_type.setItemText(2, _translate("baseui_douyin", "upload"))
        self.comboBox_upusers_type.setItemText(3, _translate("baseui_douyin", "lists"))
        self.comboBox_upusers_type.setItemText(4, _translate("baseui_douyin", "favlist"))
        ...
        item.setText(_translate("baseui_douyin", "aweme_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(2)
        item.setText(_translate("baseui_douyin", "aweme_type"))
        ...
        item.setText(_translate("baseui_douyin", "sec_uid"))
        item = self.tableWidget_video_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_douyin", "short_user_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_douyin", "user_unique_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(10)
        item.setText(_translate("baseui_douyin", "user_signature"))
        ...
        item.setText(_translate("baseui_douyin", "collected_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(15)
        item.setText(_translate("baseui_douyin", "comment_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(16)
        item.setText(_translate("baseui_douyin", "share_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(17)
        item.setText(_translate("baseui_douyin", "ip_location"))
        item = self.tableWidget_video_items.horizontalHeaderItem(18)
        item.setText(_translate("baseui_douyin", "last_modify_ts"))
        item = self.tableWidget_video_items.horizontalHeaderItem(19)
        item.setText(_translate("baseui_douyin", "aweme_url"))
        ...
        item.setText(_translate("baseui_douyin", "follows"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_douyin", "fans"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_douyin", "interaction"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_douyin", "videos_count"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_douyin", "last_modify_ts"))
