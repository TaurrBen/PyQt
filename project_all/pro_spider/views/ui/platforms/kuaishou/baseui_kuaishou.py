...
# Form implementation generated from reading ui file 'baseui_kuaishou.ui'
#
...
class Ui_baseui_kuaishou(object):
    def setupUi(self, baseui_kuaishou):
        baseui_kuaishou.setObjectName("baseui_kuaishou")
        baseui_kuaishou.resize(1368, 811)
        self.widget = QtWidgets.QWidget(baseui_kuaishou)
        ...
        self.retranslateUi(baseui_kuaishou)
        QtCore.QMetaObject.connectSlotsByName(baseui_kuaishou)

    def retranslateUi(self, baseui_kuaishou):
        _translate = QtCore.QCoreApplication.translate
        baseui_kuaishou.setWindowTitle(_translate("baseui_kuaishou", "baseui_kuaishou"))
        self.label_login_type.setText(_translate("baseui_kuaishou", "login_type:"))
        self.comboBox_login_type.setItemText(0, _translate("baseui_kuaishou", "cookies"))
        self.comboBox_login_type.setItemText(1, _translate("baseui_kuaishou", "qrcode/暂不支持"))
        self.comboBox_login_type.setItemText(2, _translate("baseui_kuaishou", "phone/暂不支持"))
        self.checkBox_is_save_login_state.setText(_translate("baseui_kuaishou", "is_save_login_state"))
        self.checkBox_is_playwright.setText(_translate("baseui_kuaishou", "playwright"))
        self.checkBox_headless.setText(_translate("baseui_kuaishou", "headless"))
        self.label_proxy_type.setText(_translate("baseui_kuaishou", "proxy:"))
        self.comboBox_proxy_type.setItemText(0, _translate("baseui_kuaishou", "none"))
        self.comboBox_proxy_type.setItemText(1, _translate("baseui_kuaishou", "kuaidaili"))
        self.label_concurrency_num.setText(_translate("baseui_kuaishou", "concurrency_num:"))
        self.lineEdit_concurrency_num.setText(_translate("baseui_kuaishou", "3"))
        self.label.setText(_translate("baseui_kuaishou", "headers:"))
        self.label_cookies2.setText(_translate("baseui_kuaishou", "cookies_in:"))
        self.label_cookies.setText(_translate("baseui_kuaishou", "cookies_out:"))
        self.comboBox_type.setItemText(0, _translate("baseui_kuaishou", "keywords"))
        self.comboBox_type.setItemText(1, _translate("baseui_kuaishou", "bvids"))
        self.comboBox_type.setItemText(2, _translate("baseui_kuaishou", "upuser"))
        self.label_keywords.setText(_translate("baseui_kuaishou", "keywords:"))
        self.lineEdit_keywords.setText(_translate("baseui_kuaishou", "神经网络,深度学习"))
        self.pushButton_keywords.setText(_translate("baseui_kuaishou", "open"))
        self.checkBox_start_page.setText(_translate("baseui_kuaishou", "start_page:"))
        self.lineEdit_start_page.setText(_translate("baseui_kuaishou", "1"))
        self.checkBox_search_type.setText(_translate("baseui_kuaishou", "search_type:"))
        self.comboBox_search_type.setItemText(0, _translate("baseui_kuaishou", "video"))
        self.comboBox_search_type.setItemText(1, _translate("baseui_kuaishou", "media_bangumi"))
        self.comboBox_search_type.setItemText(2, _translate("baseui_kuaishou", "media_ft"))
        self.comboBox_search_type.setItemText(3, _translate("baseui_kuaishou", "live"))
        self.comboBox_search_type.setItemText(4, _translate("baseui_kuaishou", "article"))
        self.comboBox_search_type.setItemText(5, _translate("baseui_kuaishou", "bili_user"))
        self.checkBox_order_type.setText(_translate("baseui_kuaishou", "order_type:"))
        self.comboBox_order_type.setItemText(0, _translate("baseui_kuaishou", "综合排序"))
        self.comboBox_order_type.setItemText(1, _translate("baseui_kuaishou", "最多播放"))
        self.comboBox_order_type.setItemText(2, _translate("baseui_kuaishou", "最新发布"))
        self.comboBox_order_type.setItemText(3, _translate("baseui_kuaishou", "最多弹幕"))
        self.comboBox_order_type.setItemText(4, _translate("baseui_kuaishou", "最多收藏"))
        self.checkBox_pubtime.setText(_translate("baseui_kuaishou", "pubtime:from"))
        self.label_pubtime.setText(_translate("baseui_kuaishou", "to"))
        self.checkBox_duration.setText(_translate("baseui_kuaishou", "duration:"))
        self.comboBox_duration.setItemText(0, _translate("baseui_kuaishou", "all"))
        self.comboBox_duration.setItemText(1, _translate("baseui_kuaishou", "<10m"))
        self.comboBox_duration.setItemText(2, _translate("baseui_kuaishou", "≥10m&<30m"))
        self.comboBox_duration.setItemText(3, _translate("baseui_kuaishou", "≥30m&<60m"))
        self.comboBox_duration.setItemText(4, _translate("baseui_kuaishou", "≥60m"))
        self.checkBox_tids.setText(_translate("baseui_kuaishou", "tids"))
        self.comboBox_tids.setItemText(0, _translate("baseui_kuaishou", "综合分区"))
        self.comboBox_tids.setItemText(1, _translate("baseui_kuaishou", "动画"))
        self.comboBox_tids.setItemText(2, _translate("baseui_kuaishou", "番剧"))
        self.comboBox_tids.setItemText(3, _translate("baseui_kuaishou", "国创"))
        self.comboBox_tids.setItemText(4, _translate("baseui_kuaishou", "音乐"))
        self.comboBox_tids.setItemText(5, _translate("baseui_kuaishou", "舞蹈"))
        self.comboBox_tids.setItemText(6, _translate("baseui_kuaishou", "游戏"))
        self.comboBox_tids.setItemText(7, _translate("baseui_kuaishou", "知识"))
        self.comboBox_tids.setItemText(8, _translate("baseui_kuaishou", "科技"))
        self.comboBox_tids.setItemText(9, _translate("baseui_kuaishou", "运动"))
        self.comboBox_tids.setItemText(10, _translate("baseui_kuaishou", "汽车"))
        self.comboBox_tids.setItemText(11, _translate("baseui_kuaishou", "生活"))
        self.comboBox_tids.setItemText(12, _translate("baseui_kuaishou", "美食"))
        self.comboBox_tids.setItemText(13, _translate("baseui_kuaishou", "动物圈"))
        self.comboBox_tids.setItemText(14, _translate("baseui_kuaishou", "鬼畜"))
        self.comboBox_tids.setItemText(15, _translate("baseui_kuaishou", "时尚"))
        self.comboBox_tids.setItemText(16, _translate("baseui_kuaishou", "咨询"))
        self.comboBox_tids.setItemText(17, _translate("baseui_kuaishou", "娱乐"))
        self.comboBox_tids.setItemText(18, _translate("baseui_kuaishou", "影视"))
        self.comboBox_tids.setItemText(19, _translate("baseui_kuaishou", "纪录片"))
        self.comboBox_tids.setItemText(20, _translate("baseui_kuaishou", "电影"))
        self.comboBox_tids.setItemText(21, _translate("baseui_kuaishou", "电视剧"))
        self.label_bvids.setText(_translate("baseui_kuaishou", "bvids:"))
        self.lineEdit_bvids.setText(_translate("baseui_kuaishou", "BV1iezPYCEY3,BV16JXXYsEXv"))
        self.pushButton_bvids.setText(_translate("baseui_kuaishou", "open"))
        self.radioButton_other_page.setText(_translate("baseui_kuaishou", "other_page"))
        self.label_upusers.setText(_translate("baseui_kuaishou", "upuser:"))
        self.lineEdit_upusers.setText(_translate("baseui_kuaishou", "339166786"))
        self.pushButton_upusers.setText(_translate("baseui_kuaishou", "open"))
        self.comboBox_upusers_type.setItemText(0, _translate("baseui_kuaishou", "home"))
        self.comboBox_upusers_type.setItemText(1, _translate("baseui_kuaishou", "dynamic"))
        self.comboBox_upusers_type.setItemText(2, _translate("baseui_kuaishou", "upload"))
        self.comboBox_upusers_type.setItemText(3, _translate("baseui_kuaishou", "lists"))
        self.comboBox_upusers_type.setItemText(4, _translate("baseui_kuaishou", "favlist"))
        self.checkBox_download_video.setText(_translate("baseui_kuaishou", "download_video"))
        self.checkBox_download_comment.setText(_translate("baseui_kuaishou", "download_comment"))
        self.checkBox_download_sub_comment.setText(_translate("baseui_kuaishou", "sub_comment"))
        self.label_video_count.setText(_translate("baseui_kuaishou", "video_count:"))
        self.lineEdit_video_count.setText(_translate("baseui_kuaishou", "20"))
        self.label_comment_count.setText(_translate("baseui_kuaishou", "comment_count:"))
        self.lineEdit_conment_count.setText(_translate("baseui_kuaishou", "20"))
        self.pushButton_load_params.setText(_translate("baseui_kuaishou", "load_params"))
        self.pushButton_start_search.setText(_translate("baseui_kuaishou", "start_search"))
        self.pushButton_stop_search.setText(_translate("baseui_kuaishou", "stop_search"))
        self.label_video_items.setText(_translate("baseui_kuaishou", "video_items"))
        self.checkBox_video_items_is_save.setText(_translate("baseui_kuaishou", "is_save"))
        self.pushButton_video_items_export.setText(_translate("baseui_kuaishou", "export"))
        item = self.tableWidget_video_items.horizontalHeaderItem(0)
        item.setText(_translate("baseui_kuaishou", "keyword"))
        item = self.tableWidget_video_items.horizontalHeaderItem(1)
        item.setText(_translate("baseui_kuaishou", "video_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(2)
        item.setText(_translate("baseui_kuaishou", "video_type"))
        item = self.tableWidget_video_items.horizontalHeaderItem(3)
        item.setText(_translate("baseui_kuaishou", "title"))
        item = self.tableWidget_video_items.horizontalHeaderItem(4)
        item.setText(_translate("baseui_kuaishou", "desc"))
        item = self.tableWidget_video_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_kuaishou", "create_time"))
        item = self.tableWidget_video_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_kuaishou", "user_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_kuaishou", "nickname"))
        item = self.tableWidget_video_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_kuaishou", "avatar"))
        item = self.tableWidget_video_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_kuaishou", "liked_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(10)
        item.setText(_translate("baseui_kuaishou", "video_play_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(11)
        item.setText(_translate("baseui_kuaishou", "video_danmaku"))
        item = self.tableWidget_video_items.horizontalHeaderItem(12)
        item.setText(_translate("baseui_kuaishou", "video_comment"))
        item = self.tableWidget_video_items.horizontalHeaderItem(13)
        item.setText(_translate("baseui_kuaishou", "last_modify_ts"))
        item = self.tableWidget_video_items.horizontalHeaderItem(14)
        item.setText(_translate("baseui_kuaishou", "video_url"))
        item = self.tableWidget_video_items.horizontalHeaderItem(15)
        item.setText(_translate("baseui_kuaishou", "video_cover_url"))
        self.label_video_upuser_items.setText(_translate("baseui_kuaishou", "video_upuser_items"))
        self.checkBox_video_upuser_items_is_save.setText(_translate("baseui_kuaishou", "is_save"))
        self.pushButton_video_upuser_items_export.setText(_translate("baseui_kuaishou", "export"))
        ...
        item.setText(_translate("baseui_kuaishou", "total_fans"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_kuaishou", "total_liked"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_kuaishou", "user_rank"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_kuaishou", "is_official"))
        self.label_logs.setText(_translate("baseui_kuaishou", "logs"))
        self.checkBox_debug.setText(_translate("baseui_kuaishou", "debug"))
        self.pushButton_clear.setText(_translate("baseui_kuaishou", "clear"))
