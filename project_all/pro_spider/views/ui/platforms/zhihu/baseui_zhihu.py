...
# Form implementation generated from reading ui file 'baseui_zhihu.ui'
#
...
class Ui_baseui_zhihu(object):
    def setupUi(self, baseui_zhihu):
        baseui_zhihu.setObjectName("baseui_zhihu")
        baseui_zhihu.resize(1368, 811)
        self.widget = QtWidgets.QWidget(baseui_zhihu)
        ...
        self.retranslateUi(baseui_zhihu)
        QtCore.QMetaObject.connectSlotsByName(baseui_zhihu)

    def retranslateUi(self, baseui_zhihu):
        _translate = QtCore.QCoreApplication.translate
        baseui_zhihu.setWindowTitle(_translate("baseui_zhihu", "baseui_zhihu"))
        self.label_login_type.setText(_translate("baseui_zhihu", "login_type:"))
        self.comboBox_login_type.setItemText(0, _translate("baseui_zhihu", "cookies"))
        self.comboBox_login_type.setItemText(1, _translate("baseui_zhihu", "qrcode/暂不支持"))
        self.comboBox_login_type.setItemText(2, _translate("baseui_zhihu", "phone/暂不支持"))
        self.checkBox_is_save_login_state.setText(_translate("baseui_zhihu", "is_save_login_state"))
        self.checkBox_is_playwright.setText(_translate("baseui_zhihu", "playwright"))
        self.checkBox_headless.setText(_translate("baseui_zhihu", "headless"))
        self.label_proxy_type.setText(_translate("baseui_zhihu", "proxy:"))
        self.comboBox_proxy_type.setItemText(0, _translate("baseui_zhihu", "none"))
        self.comboBox_proxy_type.setItemText(1, _translate("baseui_zhihu", "kuaidaili"))
        self.label_concurrency_num.setText(_translate("baseui_zhihu", "concurrency_num:"))
        self.lineEdit_concurrency_num.setText(_translate("baseui_zhihu", "3"))
        self.label.setText(_translate("baseui_zhihu", "headers:"))
        self.label_cookies2.setText(_translate("baseui_zhihu", "cookies_in:"))
        self.label_cookies.setText(_translate("baseui_zhihu", "cookies_out:"))
        self.comboBox_type.setItemText(0, _translate("baseui_zhihu", "keywords"))
        self.comboBox_type.setItemText(1, _translate("baseui_zhihu", "bvids"))
        self.comboBox_type.setItemText(2, _translate("baseui_zhihu", "upuser"))
        self.label_keywords.setText(_translate("baseui_zhihu", "keywords:"))
        self.lineEdit_keywords.setText(_translate("baseui_zhihu", "神经网络,深度学习"))
        self.pushButton_keywords.setText(_translate("baseui_zhihu", "open"))
        self.checkBox_start_page.setText(_translate("baseui_zhihu", "start_page:"))
        self.lineEdit_start_page.setText(_translate("baseui_zhihu", "1"))
        self.checkBox_search_type.setText(_translate("baseui_zhihu", "search_type:"))
        self.comboBox_search_type.setItemText(0, _translate("baseui_zhihu", "video"))
        self.comboBox_search_type.setItemText(1, _translate("baseui_zhihu", "media_bangumi"))
        self.comboBox_search_type.setItemText(2, _translate("baseui_zhihu", "media_ft"))
        self.comboBox_search_type.setItemText(3, _translate("baseui_zhihu", "live"))
        self.comboBox_search_type.setItemText(4, _translate("baseui_zhihu", "article"))
        self.comboBox_search_type.setItemText(5, _translate("baseui_zhihu", "bili_user"))
        self.checkBox_order_type.setText(_translate("baseui_zhihu", "order_type:"))
        self.comboBox_order_type.setItemText(0, _translate("baseui_zhihu", "综合排序"))
        self.comboBox_order_type.setItemText(1, _translate("baseui_zhihu", "最多播放"))
        self.comboBox_order_type.setItemText(2, _translate("baseui_zhihu", "最新发布"))
        self.comboBox_order_type.setItemText(3, _translate("baseui_zhihu", "最多弹幕"))
        self.comboBox_order_type.setItemText(4, _translate("baseui_zhihu", "最多收藏"))
        self.checkBox_pubtime.setText(_translate("baseui_zhihu", "pubtime:from"))
        self.label_pubtime.setText(_translate("baseui_zhihu", "to"))
        self.checkBox_duration.setText(_translate("baseui_zhihu", "duration:"))
        self.comboBox_duration.setItemText(0, _translate("baseui_zhihu", "all"))
        self.comboBox_duration.setItemText(1, _translate("baseui_zhihu", "<10m"))
        self.comboBox_duration.setItemText(2, _translate("baseui_zhihu", "≥10m&<30m"))
        self.comboBox_duration.setItemText(3, _translate("baseui_zhihu", "≥30m&<60m"))
        self.comboBox_duration.setItemText(4, _translate("baseui_zhihu", "≥60m"))
        self.checkBox_tids.setText(_translate("baseui_zhihu", "tids"))
        self.comboBox_tids.setItemText(0, _translate("baseui_zhihu", "综合分区"))
        self.comboBox_tids.setItemText(1, _translate("baseui_zhihu", "动画"))
        self.comboBox_tids.setItemText(2, _translate("baseui_zhihu", "番剧"))
        self.comboBox_tids.setItemText(3, _translate("baseui_zhihu", "国创"))
        self.comboBox_tids.setItemText(4, _translate("baseui_zhihu", "音乐"))
        self.comboBox_tids.setItemText(5, _translate("baseui_zhihu", "舞蹈"))
        self.comboBox_tids.setItemText(6, _translate("baseui_zhihu", "游戏"))
        self.comboBox_tids.setItemText(7, _translate("baseui_zhihu", "知识"))
        self.comboBox_tids.setItemText(8, _translate("baseui_zhihu", "科技"))
        self.comboBox_tids.setItemText(9, _translate("baseui_zhihu", "运动"))
        self.comboBox_tids.setItemText(10, _translate("baseui_zhihu", "汽车"))
        self.comboBox_tids.setItemText(11, _translate("baseui_zhihu", "生活"))
        self.comboBox_tids.setItemText(12, _translate("baseui_zhihu", "美食"))
        self.comboBox_tids.setItemText(13, _translate("baseui_zhihu", "动物圈"))
        self.comboBox_tids.setItemText(14, _translate("baseui_zhihu", "鬼畜"))
        self.comboBox_tids.setItemText(15, _translate("baseui_zhihu", "时尚"))
        self.comboBox_tids.setItemText(16, _translate("baseui_zhihu", "咨询"))
        self.comboBox_tids.setItemText(17, _translate("baseui_zhihu", "娱乐"))
        self.comboBox_tids.setItemText(18, _translate("baseui_zhihu", "影视"))
        self.comboBox_tids.setItemText(19, _translate("baseui_zhihu", "纪录片"))
        self.comboBox_tids.setItemText(20, _translate("baseui_zhihu", "电影"))
        self.comboBox_tids.setItemText(21, _translate("baseui_zhihu", "电视剧"))
        self.label_bvids.setText(_translate("baseui_zhihu", "bvids:"))
        self.lineEdit_bvids.setText(_translate("baseui_zhihu", "BV1iezPYCEY3,BV16JXXYsEXv"))
        self.pushButton_bvids.setText(_translate("baseui_zhihu", "open"))
        self.radioButton_other_page.setText(_translate("baseui_zhihu", "other_page"))
        self.label_upusers.setText(_translate("baseui_zhihu", "upuser:"))
        self.lineEdit_upusers.setText(_translate("baseui_zhihu", "339166786"))
        self.pushButton_upusers.setText(_translate("baseui_zhihu", "open"))
        self.comboBox_upusers_type.setItemText(0, _translate("baseui_zhihu", "home"))
        self.comboBox_upusers_type.setItemText(1, _translate("baseui_zhihu", "dynamic"))
        self.comboBox_upusers_type.setItemText(2, _translate("baseui_zhihu", "upload"))
        self.comboBox_upusers_type.setItemText(3, _translate("baseui_zhihu", "lists"))
        self.comboBox_upusers_type.setItemText(4, _translate("baseui_zhihu", "favlist"))
        self.checkBox_download_video.setText(_translate("baseui_zhihu", "download_video"))
        self.checkBox_download_comment.setText(_translate("baseui_zhihu", "download_comment"))
        self.checkBox_download_sub_comment.setText(_translate("baseui_zhihu", "sub_comment"))
        self.label_video_count.setText(_translate("baseui_zhihu", "video_count:"))
        self.lineEdit_video_count.setText(_translate("baseui_zhihu", "20"))
        self.label_comment_count.setText(_translate("baseui_zhihu", "comment_count:"))
        self.lineEdit_conment_count.setText(_translate("baseui_zhihu", "20"))
        self.pushButton_load_params.setText(_translate("baseui_zhihu", "load_params"))
        self.pushButton_start_search.setText(_translate("baseui_zhihu", "start_search"))
        self.pushButton_stop_search.setText(_translate("baseui_zhihu", "stop_search"))
        self.label_video_items.setText(_translate("baseui_zhihu", "video_items"))
        self.checkBox_video_items_is_save.setText(_translate("baseui_zhihu", "is_save"))
        self.pushButton_video_items_export.setText(_translate("baseui_zhihu", "export"))
        item = self.tableWidget_video_items.horizontalHeaderItem(0)
        item.setText(_translate("baseui_zhihu", "keyword"))
        item = self.tableWidget_video_items.horizontalHeaderItem(1)
        item.setText(_translate("baseui_zhihu", "video_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(2)
        item.setText(_translate("baseui_zhihu", "video_type"))
        item = self.tableWidget_video_items.horizontalHeaderItem(3)
        item.setText(_translate("baseui_zhihu", "title"))
        item = self.tableWidget_video_items.horizontalHeaderItem(4)
        item.setText(_translate("baseui_zhihu", "desc"))
        item = self.tableWidget_video_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_zhihu", "create_time"))
        item = self.tableWidget_video_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_zhihu", "user_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_zhihu", "nickname"))
        item = self.tableWidget_video_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_zhihu", "avatar"))
        item = self.tableWidget_video_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_zhihu", "liked_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(10)
        item.setText(_translate("baseui_zhihu", "video_play_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(11)
        item.setText(_translate("baseui_zhihu", "video_danmaku"))
        item = self.tableWidget_video_items.horizontalHeaderItem(12)
        item.setText(_translate("baseui_zhihu", "video_comment"))
        item = self.tableWidget_video_items.horizontalHeaderItem(13)
        item.setText(_translate("baseui_zhihu", "last_modify_ts"))
        item = self.tableWidget_video_items.horizontalHeaderItem(14)
        item.setText(_translate("baseui_zhihu", "video_url"))
        item = self.tableWidget_video_items.horizontalHeaderItem(15)
        item.setText(_translate("baseui_zhihu", "video_cover_url"))
        self.label_video_upuser_items.setText(_translate("baseui_zhihu", "video_upuser_items"))
        self.checkBox_video_upuser_items_is_save.setText(_translate("baseui_zhihu", "is_save"))
        self.pushButton_video_upuser_items_export.setText(_translate("baseui_zhihu", "export"))
        ...
        item.setText(_translate("baseui_zhihu", "total_fans"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_zhihu", "total_liked"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_zhihu", "user_rank"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_zhihu", "is_official"))
        self.label_logs.setText(_translate("baseui_zhihu", "logs"))
        self.checkBox_debug.setText(_translate("baseui_zhihu", "debug"))
        self.pushButton_clear.setText(_translate("baseui_zhihu", "clear"))
