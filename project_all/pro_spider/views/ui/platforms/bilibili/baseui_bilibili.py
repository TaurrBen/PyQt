...
class Ui_baseui_bilibili(object):
    def setupUi(self, baseui_bilibili):
        baseui_bilibili.setObjectName("baseui_bilibili")
        baseui_bilibili.resize(1368, 811)
        self.widget = QtWidgets.QWidget(baseui_bilibili)
        ...
        self.retranslateUi(baseui_bilibili)
        QtCore.QMetaObject.connectSlotsByName(baseui_bilibili)

    def retranslateUi(self, baseui_bilibili):
        _translate = QtCore.QCoreApplication.translate
        baseui_bilibili.setWindowTitle(_translate("baseui_bilibili", "baseui_bilibili"))
        self.label_login_type.setText(_translate("baseui_bilibili", "login_type:"))
        self.comboBox_login_type.setItemText(0, _translate("baseui_bilibili", "cookies"))
        self.comboBox_login_type.setItemText(1, _translate("baseui_bilibili", "qrcode/暂不支持"))
        self.comboBox_login_type.setItemText(2, _translate("baseui_bilibili", "phone/暂不支持"))
        self.checkBox_is_save_login_state.setText(_translate("baseui_bilibili", "is_save_login_state"))
        self.checkBox_is_playwright.setText(_translate("baseui_bilibili", "playwright"))
        self.checkBox_headless.setText(_translate("baseui_bilibili", "headless"))
        self.label_proxy_type.setText(_translate("baseui_bilibili", "proxy:"))
        self.comboBox_proxy_type.setItemText(0, _translate("baseui_bilibili", "none"))
        self.comboBox_proxy_type.setItemText(1, _translate("baseui_bilibili", "kuaidaili"))
        self.label_concurrency_num.setText(_translate("baseui_bilibili", "concurrency_num:"))
        self.lineEdit_concurrency_num.setText(_translate("baseui_bilibili", "3"))
        self.label.setText(_translate("baseui_bilibili", "headers:"))
        self.label_cookies2.setText(_translate("baseui_bilibili", "cookies_in:"))
        self.label_cookies.setText(_translate("baseui_bilibili", "cookies_out:"))
        self.comboBox_type.setItemText(0, _translate("baseui_bilibili", "keywords"))
        self.comboBox_type.setItemText(1, _translate("baseui_bilibili", "bvids"))
        self.comboBox_type.setItemText(2, _translate("baseui_bilibili", "upuser"))
        self.label_keywords.setText(_translate("baseui_bilibili", "keywords:"))
        self.lineEdit_keywords.setText(_translate("baseui_bilibili", "神经网络,深度学习"))
        self.pushButton_keywords.setText(_translate("baseui_bilibili", "open"))
        self.checkBox_start_page.setText(_translate("baseui_bilibili", "start_page:"))
        self.lineEdit_start_page.setText(_translate("baseui_bilibili", "1"))
        self.checkBox_search_type.setText(_translate("baseui_bilibili", "search_type:"))
        self.comboBox_search_type.setItemText(0, _translate("baseui_bilibili", "video"))
        self.comboBox_search_type.setItemText(1, _translate("baseui_bilibili", "media_bangumi"))
        self.comboBox_search_type.setItemText(2, _translate("baseui_bilibili", "media_ft"))
        self.comboBox_search_type.setItemText(3, _translate("baseui_bilibili", "live"))
        self.comboBox_search_type.setItemText(4, _translate("baseui_bilibili", "article"))
        self.comboBox_search_type.setItemText(5, _translate("baseui_bilibili", "bili_user"))
        self.checkBox_order_type.setText(_translate("baseui_bilibili", "order_type:"))
        self.comboBox_order_type.setItemText(0, _translate("baseui_bilibili", "综合排序"))
        self.comboBox_order_type.setItemText(1, _translate("baseui_bilibili", "最多播放"))
        self.comboBox_order_type.setItemText(2, _translate("baseui_bilibili", "最新发布"))
        self.comboBox_order_type.setItemText(3, _translate("baseui_bilibili", "最多弹幕"))
        self.comboBox_order_type.setItemText(4, _translate("baseui_bilibili", "最多收藏"))
        self.checkBox_pubtime.setText(_translate("baseui_bilibili", "pubtime:from"))
        self.label_pubtime.setText(_translate("baseui_bilibili", "to"))
        self.checkBox_duration.setText(_translate("baseui_bilibili", "duration:"))
        self.comboBox_duration.setItemText(0, _translate("baseui_bilibili", "all"))
        self.comboBox_duration.setItemText(1, _translate("baseui_bilibili", "<10m"))
        self.comboBox_duration.setItemText(2, _translate("baseui_bilibili", "≥10m&<30m"))
        self.comboBox_duration.setItemText(3, _translate("baseui_bilibili", "≥30m&<60m"))
        self.comboBox_duration.setItemText(4, _translate("baseui_bilibili", "≥60m"))
        self.checkBox_tids.setText(_translate("baseui_bilibili", "tids"))
        self.comboBox_tids.setItemText(0, _translate("baseui_bilibili", "综合分区"))
        self.comboBox_tids.setItemText(1, _translate("baseui_bilibili", "动画"))
        self.comboBox_tids.setItemText(2, _translate("baseui_bilibili", "番剧"))
        self.comboBox_tids.setItemText(3, _translate("baseui_bilibili", "国创"))
        self.comboBox_tids.setItemText(4, _translate("baseui_bilibili", "音乐"))
        self.comboBox_tids.setItemText(5, _translate("baseui_bilibili", "舞蹈"))
        self.comboBox_tids.setItemText(6, _translate("baseui_bilibili", "游戏"))
        self.comboBox_tids.setItemText(7, _translate("baseui_bilibili", "知识"))
        self.comboBox_tids.setItemText(8, _translate("baseui_bilibili", "科技"))
        self.comboBox_tids.setItemText(9, _translate("baseui_bilibili", "运动"))
        self.comboBox_tids.setItemText(10, _translate("baseui_bilibili", "汽车"))
        self.comboBox_tids.setItemText(11, _translate("baseui_bilibili", "生活"))
        self.comboBox_tids.setItemText(12, _translate("baseui_bilibili", "美食"))
        self.comboBox_tids.setItemText(13, _translate("baseui_bilibili", "动物圈"))
        self.comboBox_tids.setItemText(14, _translate("baseui_bilibili", "鬼畜"))
        self.comboBox_tids.setItemText(15, _translate("baseui_bilibili", "时尚"))
        self.comboBox_tids.setItemText(16, _translate("baseui_bilibili", "咨询"))
        self.comboBox_tids.setItemText(17, _translate("baseui_bilibili", "娱乐"))
        self.comboBox_tids.setItemText(18, _translate("baseui_bilibili", "影视"))
        self.comboBox_tids.setItemText(19, _translate("baseui_bilibili", "纪录片"))
        self.comboBox_tids.setItemText(20, _translate("baseui_bilibili", "电影"))
        self.comboBox_tids.setItemText(21, _translate("baseui_bilibili", "电视剧"))
        self.label_bvids.setText(_translate("baseui_bilibili", "bvids:"))
        self.lineEdit_bvids.setText(_translate("baseui_bilibili", "BV1iezPYCEY3,BV16JXXYsEXv"))
        self.pushButton_bvids.setText(_translate("baseui_bilibili", "open"))
        self.radioButton_other_page.setText(_translate("baseui_bilibili", "other_page"))
        self.label_upusers.setText(_translate("baseui_bilibili", "upuser:"))
        self.lineEdit_upusers.setText(_translate("baseui_bilibili", "339166786"))
        self.pushButton_upusers.setText(_translate("baseui_bilibili", "open"))
        self.comboBox_upusers_type.setItemText(0, _translate("baseui_bilibili", "home"))
        self.comboBox_upusers_type.setItemText(1, _translate("baseui_bilibili", "dynamic"))
        self.comboBox_upusers_type.setItemText(2, _translate("baseui_bilibili", "upload"))
        self.comboBox_upusers_type.setItemText(3, _translate("baseui_bilibili", "lists"))
        self.comboBox_upusers_type.setItemText(4, _translate("baseui_bilibili", "favlist"))
        self.checkBox_download_video.setText(_translate("baseui_bilibili", "download_video"))
        self.checkBox_download_comment.setText(_translate("baseui_bilibili", "download_comment"))
        self.checkBox_download_sub_comment.setText(_translate("baseui_bilibili", "sub_comment"))
        self.label_video_count.setText(_translate("baseui_bilibili", "video_count:"))
        self.lineEdit_video_count.setText(_translate("baseui_bilibili", "20"))
        self.label_comment_count.setText(_translate("baseui_bilibili", "comment_count:"))
        self.lineEdit_conment_count.setText(_translate("baseui_bilibili", "20"))
        self.pushButton_load_params.setText(_translate("baseui_bilibili", "load_params"))
        self.pushButton_start_search.setText(_translate("baseui_bilibili", "start_search"))
        self.pushButton_stop_search.setText(_translate("baseui_bilibili", "stop_search"))
        self.label_video_items.setText(_translate("baseui_bilibili", "video_items"))
        self.checkBox_video_items_is_save.setText(_translate("baseui_bilibili", "is_save"))
        self.pushButton_video_items_export.setText(_translate("baseui_bilibili", "export"))
        item = self.tableWidget_video_items.horizontalHeaderItem(0)
        item.setText(_translate("baseui_bilibili", "keyword"))
        item = self.tableWidget_video_items.horizontalHeaderItem(1)
        item.setText(_translate("baseui_bilibili", "video_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(2)
        item.setText(_translate("baseui_bilibili", "video_type"))
        item = self.tableWidget_video_items.horizontalHeaderItem(3)
        item.setText(_translate("baseui_bilibili", "title"))
        item = self.tableWidget_video_items.horizontalHeaderItem(4)
        item.setText(_translate("baseui_bilibili", "desc"))
        item = self.tableWidget_video_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_bilibili", "create_time"))
        item = self.tableWidget_video_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_bilibili", "user_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_bilibili", "nickname"))
        item = self.tableWidget_video_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_bilibili", "avatar"))
        item = self.tableWidget_video_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_bilibili", "liked_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(10)
        item.setText(_translate("baseui_bilibili", "video_play_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(11)
        item.setText(_translate("baseui_bilibili", "video_danmaku"))
        item = self.tableWidget_video_items.horizontalHeaderItem(12)
        item.setText(_translate("baseui_bilibili", "video_comment"))
        item = self.tableWidget_video_items.horizontalHeaderItem(13)
        item.setText(_translate("baseui_bilibili", "last_modify_ts"))
        item = self.tableWidget_video_items.horizontalHeaderItem(14)
        item.setText(_translate("baseui_bilibili", "video_url"))
        item = self.tableWidget_video_items.horizontalHeaderItem(15)
        item.setText(_translate("baseui_bilibili", "video_cover_url"))
        self.label_video_upuser_items.setText(_translate("baseui_bilibili", "video_upuser_items"))
        self.checkBox_video_upuser_items_is_save.setText(_translate("baseui_bilibili", "is_save"))
        self.pushButton_video_upuser_items_export.setText(_translate("baseui_bilibili", "export"))
        ...
        item.setText(_translate("baseui_bilibili", "total_fans"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_bilibili", "total_liked"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_bilibili", "user_rank"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_bilibili", "is_official"))
        self.label_logs.setText(_translate("baseui_bilibili", "logs"))
        self.checkBox_debug.setText(_translate("baseui_bilibili", "debug"))
        self.pushButton_clear.setText(_translate("baseui_bilibili", "clear"))
