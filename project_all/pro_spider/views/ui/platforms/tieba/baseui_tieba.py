...
# Form implementation generated from reading ui file 'baseui_tieba.ui'
#
...
class Ui_baseui_tieba(object):
    def setupUi(self, baseui_tieba):
        baseui_tieba.setObjectName("baseui_tieba")
        baseui_tieba.resize(1368, 811)
        self.widget = QtWidgets.QWidget(baseui_tieba)
        ...
        self.retranslateUi(baseui_tieba)
        QtCore.QMetaObject.connectSlotsByName(baseui_tieba)

    def retranslateUi(self, baseui_tieba):
        _translate = QtCore.QCoreApplication.translate
        baseui_tieba.setWindowTitle(_translate("baseui_tieba", "baseui_tieba"))
        self.label_login_type.setText(_translate("baseui_tieba", "login_type:"))
        self.comboBox_login_type.setItemText(0, _translate("baseui_tieba", "cookies"))
        self.comboBox_login_type.setItemText(1, _translate("baseui_tieba", "qrcode/暂不支持"))
        self.comboBox_login_type.setItemText(2, _translate("baseui_tieba", "phone/暂不支持"))
        self.checkBox_is_save_login_state.setText(_translate("baseui_tieba", "is_save_login_state"))
        self.checkBox_is_playwright.setText(_translate("baseui_tieba", "playwright"))
        self.checkBox_headless.setText(_translate("baseui_tieba", "headless"))
        self.label_proxy_type.setText(_translate("baseui_tieba", "proxy:"))
        self.comboBox_proxy_type.setItemText(0, _translate("baseui_tieba", "none"))
        self.comboBox_proxy_type.setItemText(1, _translate("baseui_tieba", "kuaidaili"))
        self.label_concurrency_num.setText(_translate("baseui_tieba", "concurrency_num:"))
        self.lineEdit_concurrency_num.setText(_translate("baseui_tieba", "3"))
        self.label.setText(_translate("baseui_tieba", "headers:"))
        self.label_cookies2.setText(_translate("baseui_tieba", "cookies_in:"))
        self.label_cookies.setText(_translate("baseui_tieba", "cookies_out:"))
        self.comboBox_type.setItemText(0, _translate("baseui_tieba", "keywords"))
        self.comboBox_type.setItemText(1, _translate("baseui_tieba", "bvids"))
        self.comboBox_type.setItemText(2, _translate("baseui_tieba", "upuser"))
        self.label_keywords.setText(_translate("baseui_tieba", "keywords:"))
        self.lineEdit_keywords.setText(_translate("baseui_tieba", "神经网络,深度学习"))
        self.pushButton_keywords.setText(_translate("baseui_tieba", "open"))
        self.checkBox_start_page.setText(_translate("baseui_tieba", "start_page:"))
        self.lineEdit_start_page.setText(_translate("baseui_tieba", "1"))
        self.checkBox_search_type.setText(_translate("baseui_tieba", "search_type:"))
        self.comboBox_search_type.setItemText(0, _translate("baseui_tieba", "video"))
        self.comboBox_search_type.setItemText(1, _translate("baseui_tieba", "media_bangumi"))
        self.comboBox_search_type.setItemText(2, _translate("baseui_tieba", "media_ft"))
        self.comboBox_search_type.setItemText(3, _translate("baseui_tieba", "live"))
        self.comboBox_search_type.setItemText(4, _translate("baseui_tieba", "article"))
        self.comboBox_search_type.setItemText(5, _translate("baseui_tieba", "bili_user"))
        self.checkBox_order_type.setText(_translate("baseui_tieba", "order_type:"))
        self.comboBox_order_type.setItemText(0, _translate("baseui_tieba", "综合排序"))
        self.comboBox_order_type.setItemText(1, _translate("baseui_tieba", "最多播放"))
        self.comboBox_order_type.setItemText(2, _translate("baseui_tieba", "最新发布"))
        self.comboBox_order_type.setItemText(3, _translate("baseui_tieba", "最多弹幕"))
        self.comboBox_order_type.setItemText(4, _translate("baseui_tieba", "最多收藏"))
        self.checkBox_pubtime.setText(_translate("baseui_tieba", "pubtime:from"))
        self.label_pubtime.setText(_translate("baseui_tieba", "to"))
        self.checkBox_duration.setText(_translate("baseui_tieba", "duration:"))
        self.comboBox_duration.setItemText(0, _translate("baseui_tieba", "all"))
        self.comboBox_duration.setItemText(1, _translate("baseui_tieba", "<10m"))
        self.comboBox_duration.setItemText(2, _translate("baseui_tieba", "≥10m&<30m"))
        self.comboBox_duration.setItemText(3, _translate("baseui_tieba", "≥30m&<60m"))
        self.comboBox_duration.setItemText(4, _translate("baseui_tieba", "≥60m"))
        self.checkBox_tids.setText(_translate("baseui_tieba", "tids"))
        self.comboBox_tids.setItemText(0, _translate("baseui_tieba", "综合分区"))
        self.comboBox_tids.setItemText(1, _translate("baseui_tieba", "动画"))
        self.comboBox_tids.setItemText(2, _translate("baseui_tieba", "番剧"))
        self.comboBox_tids.setItemText(3, _translate("baseui_tieba", "国创"))
        self.comboBox_tids.setItemText(4, _translate("baseui_tieba", "音乐"))
        self.comboBox_tids.setItemText(5, _translate("baseui_tieba", "舞蹈"))
        self.comboBox_tids.setItemText(6, _translate("baseui_tieba", "游戏"))
        self.comboBox_tids.setItemText(7, _translate("baseui_tieba", "知识"))
        self.comboBox_tids.setItemText(8, _translate("baseui_tieba", "科技"))
        self.comboBox_tids.setItemText(9, _translate("baseui_tieba", "运动"))
        self.comboBox_tids.setItemText(10, _translate("baseui_tieba", "汽车"))
        self.comboBox_tids.setItemText(11, _translate("baseui_tieba", "生活"))
        self.comboBox_tids.setItemText(12, _translate("baseui_tieba", "美食"))
        self.comboBox_tids.setItemText(13, _translate("baseui_tieba", "动物圈"))
        self.comboBox_tids.setItemText(14, _translate("baseui_tieba", "鬼畜"))
        self.comboBox_tids.setItemText(15, _translate("baseui_tieba", "时尚"))
        self.comboBox_tids.setItemText(16, _translate("baseui_tieba", "咨询"))
        self.comboBox_tids.setItemText(17, _translate("baseui_tieba", "娱乐"))
        self.comboBox_tids.setItemText(18, _translate("baseui_tieba", "影视"))
        self.comboBox_tids.setItemText(19, _translate("baseui_tieba", "纪录片"))
        self.comboBox_tids.setItemText(20, _translate("baseui_tieba", "电影"))
        self.comboBox_tids.setItemText(21, _translate("baseui_tieba", "电视剧"))
        self.label_bvids.setText(_translate("baseui_tieba", "bvids:"))
        self.lineEdit_bvids.setText(_translate("baseui_tieba", "BV1iezPYCEY3,BV16JXXYsEXv"))
        self.pushButton_bvids.setText(_translate("baseui_tieba", "open"))
        self.radioButton_other_page.setText(_translate("baseui_tieba", "other_page"))
        self.label_upusers.setText(_translate("baseui_tieba", "upuser:"))
        self.lineEdit_upusers.setText(_translate("baseui_tieba", "339166786"))
        self.pushButton_upusers.setText(_translate("baseui_tieba", "open"))
        self.comboBox_upusers_type.setItemText(0, _translate("baseui_tieba", "home"))
        self.comboBox_upusers_type.setItemText(1, _translate("baseui_tieba", "dynamic"))
        self.comboBox_upusers_type.setItemText(2, _translate("baseui_tieba", "upload"))
        self.comboBox_upusers_type.setItemText(3, _translate("baseui_tieba", "lists"))
        self.comboBox_upusers_type.setItemText(4, _translate("baseui_tieba", "favlist"))
        self.checkBox_download_video.setText(_translate("baseui_tieba", "download_video"))
        self.checkBox_download_comment.setText(_translate("baseui_tieba", "download_comment"))
        self.checkBox_download_sub_comment.setText(_translate("baseui_tieba", "sub_comment"))
        self.label_video_count.setText(_translate("baseui_tieba", "video_count:"))
        self.lineEdit_video_count.setText(_translate("baseui_tieba", "20"))
        self.label_comment_count.setText(_translate("baseui_tieba", "comment_count:"))
        self.lineEdit_conment_count.setText(_translate("baseui_tieba", "20"))
        self.pushButton_load_params.setText(_translate("baseui_tieba", "load_params"))
        self.pushButton_start_search.setText(_translate("baseui_tieba", "start_search"))
        self.pushButton_stop_search.setText(_translate("baseui_tieba", "stop_search"))
        self.label_video_items.setText(_translate("baseui_tieba", "video_items"))
        self.checkBox_video_items_is_save.setText(_translate("baseui_tieba", "is_save"))
        self.pushButton_video_items_export.setText(_translate("baseui_tieba", "export"))
        item = self.tableWidget_video_items.horizontalHeaderItem(0)
        item.setText(_translate("baseui_tieba", "keyword"))
        item = self.tableWidget_video_items.horizontalHeaderItem(1)
        item.setText(_translate("baseui_tieba", "video_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(2)
        item.setText(_translate("baseui_tieba", "video_type"))
        item = self.tableWidget_video_items.horizontalHeaderItem(3)
        item.setText(_translate("baseui_tieba", "title"))
        item = self.tableWidget_video_items.horizontalHeaderItem(4)
        item.setText(_translate("baseui_tieba", "desc"))
        item = self.tableWidget_video_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_tieba", "create_time"))
        item = self.tableWidget_video_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_tieba", "user_id"))
        item = self.tableWidget_video_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_tieba", "nickname"))
        item = self.tableWidget_video_items.horizontalHeaderItem(8)
        item.setText(_translate("baseui_tieba", "avatar"))
        item = self.tableWidget_video_items.horizontalHeaderItem(9)
        item.setText(_translate("baseui_tieba", "liked_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(10)
        item.setText(_translate("baseui_tieba", "video_play_count"))
        item = self.tableWidget_video_items.horizontalHeaderItem(11)
        item.setText(_translate("baseui_tieba", "video_danmaku"))
        item = self.tableWidget_video_items.horizontalHeaderItem(12)
        item.setText(_translate("baseui_tieba", "video_comment"))
        item = self.tableWidget_video_items.horizontalHeaderItem(13)
        item.setText(_translate("baseui_tieba", "last_modify_ts"))
        item = self.tableWidget_video_items.horizontalHeaderItem(14)
        item.setText(_translate("baseui_tieba", "video_url"))
        item = self.tableWidget_video_items.horizontalHeaderItem(15)
        item.setText(_translate("baseui_tieba", "video_cover_url"))
        self.label_video_upuser_items.setText(_translate("baseui_tieba", "video_upuser_items"))
        self.checkBox_video_upuser_items_is_save.setText(_translate("baseui_tieba", "is_save"))
        self.pushButton_video_upuser_items_export.setText(_translate("baseui_tieba", "export"))
        ...
        item.setText(_translate("baseui_tieba", "total_fans"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(5)
        item.setText(_translate("baseui_tieba", "total_liked"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(6)
        item.setText(_translate("baseui_tieba", "user_rank"))
        item = self.tableWidget_upuser_items.horizontalHeaderItem(7)
        item.setText(_translate("baseui_tieba", "is_official"))
        self.label_logs.setText(_translate("baseui_tieba", "logs"))
        self.checkBox_debug.setText(_translate("baseui_tieba", "debug"))
        self.pushButton_clear.setText(_translate("baseui_tieba", "clear"))
