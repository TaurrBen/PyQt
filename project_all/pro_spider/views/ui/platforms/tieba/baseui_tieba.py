...
class Ui_baseui_tieba(object):
    ...
    def retranslateUi(self, baseui_tieba):
        ...
        self.comboBox_type.setItemText(0, _translate("baseui_tieba", "keyword"))
        self.comboBox_type.setItemText(1, _translate("baseui_tieba", "bvid"))
        self.comboBox_type.setItemText(2, _translate("baseui_tieba", "upuser"))
        self.label_keyword.setText(_translate("baseui_tieba", "keyword:"))
        self.lineEdit_keyword.setText(_translate("baseui_tieba", "神经网络,深度学习"))
        self.pushButton_keyword.setText(_translate("baseui_tieba", "open"))
        ...
        self.label_bvid.setText(_translate("baseui_tieba", "bvid:"))
        self.pushButton_bvid.setText(_translate("baseui_tieba", "open"))
        self.radioButton_other_page.setText(_translate("baseui_tieba", "other_page"))
        self.label_upuser.setText(_translate("baseui_tieba", "upuser:"))
        self.pushButton_upuser.setText(_translate("baseui_tieba", "open"))
        self.comboBox_upuser_type.setItemText(0, _translate("baseui_tieba", "home"))
        self.comboBox_upuser_type.setItemText(1, _translate("baseui_tieba", "dynamic"))
        self.comboBox_upuser_type.setItemText(2, _translate("baseui_tieba", "upload"))
        self.comboBox_upuser_type.setItemText(3, _translate("baseui_tieba", "lists"))
        self.comboBox_upuser_type.setItemText(4, _translate("baseui_tieba", "favlist"))
        ...
        item.setText(_translate("baseui_tieba", "source_keyword"))
