...
from .ui.platforms.kuaishou.ui_kuaishou import Ui_kuaishou
import config
from utils.log import *
from ..controllers.platforms import CrawlerFactory, KuaishouCrawler
...
class View_kuaishou():
    ...
    def __init__(self, parent):
        ...
        super(View_kuaishou, self).__init__()
        self.build_ui(self.parent)
        self.ui.show()

    def build_ui(self,parent):
        self.ui = Ui_kuaishou(parent)
        self.setup_bindings()
    ...
    def btn_load_params_clicked(self):
        ...
        ## check params
        if not isinstance(self.ctrl.crawler, KuaishouCrawler):
            self.ctrl.crawler = CrawlerFactory.create_crawler(self, platform="kuaishou")
