...
from ..controllers.platforms import CrawlerFactory, BilibiliCrawler
...
class View_bilibili():
    ...
    def __init__(self, parent):
        ...
        super(View_bilibili, self).__init__()
    ...
    def btn_load_params_clicked(self):
        ...
        ## check params
        if not isinstance(self.ctrl.crawler,BilibiliCrawler):
            self.ctrl.crawler = CrawlerFactory.create_crawler(self, platform="bilibili")
