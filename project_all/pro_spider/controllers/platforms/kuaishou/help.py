...
class KuaiShouGraphQL:
    ...
    def __init__(self):
        self.graphql_dir = "project_all\pro_spider\controllers\platforms\kuaishou\graphql"
        self.load_graphql_queries()

    def load_graphql_queries(self):
        graphql_files = ["search_query.graphql",
        ...
        for file in graphql_files:
            with open(os.path.join(os.getcwd(),self.graphql_dir,file), mode="r") as f:
