...
class XiaoHongShuCrawler(AbstractCrawler):
    ...
    async def get_creators_and_notes(self) -> None:
        ...
        for user_id in config.XHS_CREATOR_ID_LIST:
            ...
            if createor_info:
                await xiaohongshu_store.save_creator(user_id, creator=createor_info)
    ...
    async def get_comments(
        ...
        async with semaphore:
            ...
            await self.xhs_client.get_note_all_comments(
                ...
                crawl_interval=crawl_interval,
                callback=xiaohongshu_store.batch_update_xhs_note_comments,
    ...
    async def close(self):
        ...
        config.logger.info("[XiaoHongShuCrawler.close] Browser context closed ...")
    ...
    async def get_note_images(self, note_item: Dict):
        ...
        for pic in image_list:
            ...
            picNum += 1
            await xiaohongshu_store.update_xhs_note_image(note_id, content, extension_file_name)
    ...
    async def get_notice_video(self, note_item: Dict):
        ...
        videos = xiaohongshu_store.get_video_url_arr(note_item)
