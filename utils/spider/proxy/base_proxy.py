...
class IpCache:
    def __init__(self):
        self.cache_client: AbstractCache = CacheFactory.create_cache(cache_type="memory")
    ...
    def load_all_ip(self, proxy_brand_name: str) -> List[IpInfoModel]:
        ...
        try:
            ...
            config.logger.error("[IpCache.load_all_ip] get ip err from redis db", e)
        return all_ip_list
