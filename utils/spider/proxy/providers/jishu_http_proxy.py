...
"""
# File       : jishu_http_proxy.py
# Time       ：2025.2.22 10:53
# Author     ：Benboy
# Email      : hgq1633923487@gmail.com
# version    ：python 3.9
# Description：已废弃！！！！！倒闭了！！！极速HTTP 代理IP实现. 请使用快代理实现（proxy/providers/kuaidl_proxy.py）
"""
...
class JiSuHttpProxy(ProxyProvider):
    ...
    async def get_proxies(self, num: int) -> List[IpInfoModel]:
        ...
        async with httpx.AsyncClient() as client:
            ...
            config.logger.info(f"[JiSuHttpProxy.get_proxies] get ip proxy url:{url}")
            ...
            if res_dict.get("code") == 0:
                ...
                current_ts = time_utils.get_unix_timestamp()
                for ip_item in data:
                    ip_info_model = IpInfoModel(
                        ...
                        expired_time_ts=time_utils.get_unix_time_from_time_str(ip_item.get("expire"))
                    )
