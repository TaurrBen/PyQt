__author__ = 'cyrbuzz'
# 方便扩展，抽象成基类。
from base import (QCursor, QFrame, Qt, QTabWidget, QTextEdit, QLabel, QIcon, QPushButton, QVBoxLayout,
                  QGridLayout, PicLabel, ScrollArea, TableWidget, VBoxLayout, HBoxLayout, pyqtSignal)
